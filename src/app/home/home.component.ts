...
export class HomeComponent implements OnInit {
  ...
  dataCard: Card[] = [
    ...
    { image: './assets/ecommerceApp.png', textHead: 'Ecommerce', textFooter:'Pokedex desenvolvida em duas versões, uma em React e outra em Angular. Neste projeto apliquei a metodologia MobileFirst, deixando toda a aplicação responsiva para se adaptar À celulares e desktops. Sem bibliotecas, sendo todo layout aplicado apenas com o CSS e HTML puro. Requisições com o axios consumindo minha própria API desenvolvida com .NET', linkButton:'http://e-commerce-quadros-v1.s3-website-sa-east-1.amazonaws.com/' },
  ];
}
